        ...
        return (
            <>
                <div role="status" className="relative rounded animate-pulse p-3">
                    <div className="flex items-center justify-center w-auto h-52 bg-gray-300 rounded-lg dark:bg-white/10">
        ...
        <>
            <div className='relative'>
                <div className="poster relative">
                    <Link to={`/watch/${video?.id}`} className="block relative w-auto h-52 md:rounded-xl overflow-hidden">
                        <LazyLoadImage
